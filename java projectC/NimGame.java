public class NimGame
{
    ...
    {
        NimPlayer player1 = new NimAIPlayer();
        NimPlayer player2 = new NimHumanPlayer();
        ...
        while (stoneCurrentCount > 0)
        {
            ...
            if (count%2 == 1)
            {
                ...
                if ((gain.judgeAI(userName1)) == true)
                {
                    int numberToRemove = player1.removeStone(stoneCurrentCount, stoneRemovalUpperBound);
                    stoneCurrentCount -= numberToRemove;
                    count++;
                }
                else
                {
                    int numberToRemove = player2.removeStone(stoneCurrentCount, stoneRemovalUpperBound);
            ...
            else
            {
                ...
                if (gain.judgeAI(userName2) == true)
                {
                    int numberToRemove = player1.removeStone(stoneCurrentCount, stoneRemovalUpperBound);
                    stoneCurrentCount -= numberToRemove;
                    count++;
